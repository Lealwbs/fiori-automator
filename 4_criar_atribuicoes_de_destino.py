...
def preencherIniciandoEm(indexInicio = 0, tempoEspera = 1 ):
    ...
    for i in range(qtdeDados):
        ...
        #py.press('tab', 8)  #Antiga forma (Muito problemática)
        py.click()  #Criar atribuição de Destino IMPORTANTE!
        time.sleep(tempoEspera * 5)
        ...
        print(f"{objeto} - {transacao} - {descricao} foi cadastrado.")
